...
EXPLANATIONS = {
    'Dyskeratotic': "Dyskeratotic: Refers to cells with abnormal keratinization. These changes can be associated with pre-cancerous conditions or other pathological changes.",
    'Koilocytotic': "Koilocytotic: These cells are typically seen in infections caused by the human papillomavirus (HPV) and may indicate pre-cancerous changes.",
    'Metaplastic': "Metaplastic: Metaplasia is a process where one type of cell changes into another type. In the cervix, this can be a normal process, but sometimes it may be associated with pre-cancerous changes.",
    'Parabasal': "Parabasal: Cells that are typically found in the lower layers of the cervix epithelium. An increase in these cells can indicate atrophic changes, especially in postmenopausal women.",
    'Superficial-Intermediate': "Superficial-Intermediate: These cells are generally found on the surface of the cervix and are normal in a healthy cervix. Changes in these cells can sometimes indicate underlying pathology."
}
...
with tabs[1]:
    ...
    <div style='border: 2px solid #2980B9; padding: 9px; border-radius: 10px; margin-top: 10px;'>
        ...
        <p style='color: #F0FFFF;'>To ensure accurate predictions for cervical cancer, please follow these guidelines when uploading images:</p>
        <ul style='color: #F0FFFF;'>
            <li>Ensure that the images are clear and focused, allowing for accurate analysis of the details.</li>
            <li>Preferably upload medical images related to cervical cancer, such as Pap smear images, biopsy samples, or colposcopy images.</li>
    ...
    <div style='border: 2px solid #2980B9; padding: 15px; border-radius: 10px; margin-top: 20px;'>
        ...
        <ul style='color: #F0FFFF;'>
            <li><strong>Dyskeratotic:</strong> Refers to cells with abnormal keratinization. These changes can be associated with pre-cancerous conditions or other pathological changes.</li>
            <li><strong>Koilocytotic:</strong> These cells are typically seen in infections caused by the human papillomavirus (HPV) and may indicate pre-cancerous changes.</li>
            <li><strong>Metaplastic:</strong> Metaplasia is a process where one type of cell changes into another type. In the cervix, this can be a normal process, but sometimes it may be associated with pre-cancerous changes.</li>
            <li><strong>Parabasal:</strong> Cells that are typically found in the lower layers of the cervix epithelium. An increase in these cells can indicate atrophic changes, especially in postmenopausal women.</li>
            <li><strong>Superficial-Intermediate:</strong> These cells are generally found on the surface of the cervix and are normal in a healthy cervix. Changes in these cells can sometimes indicate underlying pathology.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
